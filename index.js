...
bot.on('message', message => {
  if (message.content === 'Sorry') {
   // message.reply('pong');
    message.channel.sendMessage('Shawty Shawty');
  }
});
...
bot.on('ready', ()=>{
  ...
  voiceChannel = bot.guilds.find('name', 'DREAMENERG3T1CER').channels.find('name', 'SHINDONG');
...
bot.login('NDA4MDc1NDU0NDkxMjYyOTc3.DVLTuA.OWWul5WuomHSEbN2wLP3Mfn-mcA');
